        ...
        <div className="work-container">
          <div className="work-canvas">
            <Canvas>
              ...
              <OrbitControls enableZoom={false} maxPolarAngle={Math.PI /3} minPolarAngle={Math.PI/4} />
              ...
              {workExperiences.map(({id,name,pos,icon,duration,title,animation}) => (
                <div
                  ...
                  <div className="sm:p-5 px-2.5 py-5">
                    ...
                    <p className="group-hover:text-white transition-all ease-in-out duration-200">{title}</p>
                  </div>
                </div>
              ))}
            </div>
